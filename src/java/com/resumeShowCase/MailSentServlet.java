...
public class MailSentServlet extends HttpServlet 
{
            ...
            throws ServletException, IOException 
    {
        ...
        log("class MailSent Name::" + name);
        log("class MailSent Email::" + email);
        log("class MailSent Message::" + message);
        log("class MailSent Path::" + fullPath);
        log(sc.getInitParameter("myEmail"));
